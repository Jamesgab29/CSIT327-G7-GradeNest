...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "accounts.context_processors.static_cache_buster",  # Add cache buster
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "jamesgabrielflorescotiangco@gmail.com"          # 🔹 Replace with your Gmail
EMAIL_HOST_PASSWORD = "eluotkoayyantcwi"    # 🔹 Replace with your Gmail App Password
